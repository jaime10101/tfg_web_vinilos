...
/* ============================================================
   ...
   ============================================================ */
const VINYLS = {
    1:  { name: "AM",                        artist: "Arctic Monkeys",    price: 25, genre: "Indie",       format: "LP",    year: 2013, badge: "restock",   popularity: 95, image: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&q=80",  desc: "El quinto álbum de Arctic Monkeys, grabado en Los Ángeles y Nashville. Un viaje desde el garage rock hasta el hard rock con influencias de hip-hop y R&B." },
    ...
    5:  { name: "After Hours",               artist: "The Weeknd",        price: 35, genre: "Pop",         format: "LP",    year: 2020, badge: "limitado",  popularity: 97, image: "https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=800&q=80",  desc: "El cuarto álbum de The Weeknd, un viaje oscuro y cinemático por las noches de Los Ángeles." },
    6:  { name: "Future Nostalgia",          artist: "Dua Lipa",          price: 27, genre: "Pop",         format: "LP",    year: 2020, badge: "restock",   popularity: 92, image: "https://images.unsplash.com/photo-1598387846148-47e82ee120cc?w=800&q=80",  desc: "El segundo álbum de Dua Lipa, un brillante homenaje al pop de los 80 y al disco." },
    7:  { name: "Fine Line",                 artist: "Harry Styles",      price: 29, genre: "Pop",         format: "Doble", year: 2019, badge: null,        popularity: 91, image: "https://images.unsplash.com/photo-1571330735066-03aaa9429d89?w=800&q=80",  desc: "El segundo álbum en solitario de Harry Styles, una exploración de folk rock, pop y soul." },
    ...
    10: { name: "In Rainbows",               artist: "Radiohead",         price: 45, genre: "Indie",       format: "Doble", year: 2007, badge: null,        popularity: 94, image: "https://images.unsplash.com/photo-1513151233558-d860c5398176?w=800&q=80",  desc: "El séptimo álbum de Radiohead, famoso por ser lanzado como descarga de pago libre." },
    ...
    14: { name: "Illmatic",                  artist: "Nas",               price: 31, genre: "Hip Hop",     format: "LP",    year: 1994, badge: null,        popularity: 96, image: "https://images.unsplash.com/photo-1571330735066-03aaa9429d89?w=800&q=80",  desc: "El álbum debut de Nas, considerado el mejor álbum de rap de la historia." },
    15: { name: "Motomami",                  artist: "Rosalía",           price: 40, genre: "Pop",         format: "LP",    year: 2022, badge: "nuevo",     popularity: 94, image: "https://images.unsplash.com/photo-1602020919491-6b7696a96ee5?w=800&q=80",  desc: "El tercer álbum de Rosalía, una exploración del flamenco fusionado con reggaetón." },
    16: { name: "Un Verano Sin Ti",          artist: "Bad Bunny",         price: 38, genre: "Latina",      format: "Doble", year: 2022, badge: "nuevo",     popularity: 97, image: "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=800&q=80",  desc: "El álbum más escuchado en Spotify en 2022. Combina reggaetón, salsa y dembow." },
    ...
    18: { name: "The Dark Side of the Moon", artist: "Pink Floyd",        price: 44, genre: "Rock",        format: "LP",    year: 1973, badge: null,        popularity: 99, image: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&q=80",  desc: "El octavo álbum de Pink Floyd, uno de los discos más vendidos de la historia." },
    ...
    21: { name: "Selected Ambient Works",    artist: "Aphex Twin",        price: 42, genre: "Electrónica", format: "Doble", year: 1992, badge: "pre-orden", popularity: 86, image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=80",  desc: "El debut de Aphex Twin, piedra angular de la música electrónica ambiental." },
...
/* Velocidad de reproducción según formato */
const VELOCIDADES = {
    LP:     '33 rpm',
    EP:     '45 rpm',
    Single: '45 rpm',
...
/* Carga el vinilo desde el parámetro ?id= de la URL */
function loadVinilo() {
    const params = new URLSearchParams(window.location.search);
    const id     = parseInt(params.get('id')) || 1;
    const v      = VINYLS[id];
    if (!v) {
        document.getElementById('nombreAlbum').textContent = 'Vinilo no encontrado';
        return;
    }
    ...
    /* Cabecera — género, título y artista */
...
/* Carga los vinilos relacionados — mismo género primero */
function cargarRelacionados(idActual, genero) {
    ...
    /* Prioriza mismo género, luego rellena con otros */
    const relacionados = [
        ...todos.filter(v => v.id !== idActual && v.genre === genero).sort(() => Math.random() - 0.5),
        ...todos.filter(v => v.id !== idActual && v.genre !== genero).sort(() => Math.random() - 0.5)
    ].slice(0, 6);
